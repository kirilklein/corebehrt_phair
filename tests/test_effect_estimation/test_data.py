...
class TestOutcomePredictionFunctions(unittest.TestCase):
    ...
    def test_assign_counterfactuals(self):
        ...
        np.testing.assert_array_almost_equal(
            df[COUNTERFACTUAL_TREATED_COL], expected_Y1_hat
        )
        np.testing.assert_array_almost_equal(
            df[COUNTERFACTUAL_CONTROL_COL], expected_Y0_hat
        )
    ...
    def test_assign_counterfactuals_with_nonbinary_treatment(self):
        ...
        np.testing.assert_array_almost_equal(
            df_result[COUNTERFACTUAL_TREATED_COL], expected_Y1_hat
        )
        np.testing.assert_array_almost_equal(
            df_result[COUNTERFACTUAL_CONTROL_COL], expected_Y0_hat
        )
