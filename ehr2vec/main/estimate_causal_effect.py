...
def main():
    cfg, run, mount_context, azure_context = initialize_configuration_measure_effect(
    ...
    pids_outcome_treated, probas_outcome_treated, _ = (
        load_predictions_from_finetune_dir(outcome_treated_folder)
    )
    pids_outcome_untreated, probas_outcome_untreated, _ = (
        load_predictions_from_finetune_dir(outcome_untreated_folder)
    )
